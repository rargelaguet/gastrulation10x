...
io$differential_results <- file.path(io$basedir,"results/differential/celltypes/pseudobulk")
io$outdir <- file.path(io$basedir,"results/differential/celltypes/pseudobulk/out"); dir.create(io$outdir, showWarnings = F)
