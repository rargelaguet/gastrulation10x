...
if (grepl("ricard",Sys.info()['nodename'])) {
  ...
  source("/Users/ricard/gastrulation10x/mapping/celltypes/utils.R")
  ...
  source("/homes/ricard/gastrulation10x/mapping/celltypes/utils.R")
  io$load_data_script <- "/homes/ricard/gastrulation10x/mapping/load_data.R"
}  
io$outdir <- paste0(io$basedir,"/results/mapping/celltypes")
...
# MNN
mapping.dt <- mnn.fn(sce.all, sce.query, sce.atlas, genes = genes, npcs = 25, k = 15)
