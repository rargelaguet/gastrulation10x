...
groups(model) <- unname(rename.groups)

# sample_metadata[,sample:=stringr::str_replace_all(sample,rename.groups)]
```
...
```{r}
# pdf(paste0(io$pdfdir,"/factor_correlation.pdf"), width=6, height=6, useDingbats = F)
