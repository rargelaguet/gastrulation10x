...
io$outfile <- paste0(io$outdir,"/data/E7.0.txt")
...
io$seurat <- sprintf("%s/processed/seurat/seurat_E7.0.rds",io$basedir)
...
for (i in names(m_batch)) {
  filename <- sprintf("%s/data/E7.0_%s.txt",io$outdir,i)
