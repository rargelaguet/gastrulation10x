...
p.add_argument( '--start_stochastic',       type=int,              default=1,              help='start_stochastic')
...
if args.stochastic_inference:
    ent.set_stochastic_options(learning_rate=args.learning_rate, forgetting_rate=args.forgetting_rate, batch_size=args.batch_size, start_stochastic=args.start_stochastic)
